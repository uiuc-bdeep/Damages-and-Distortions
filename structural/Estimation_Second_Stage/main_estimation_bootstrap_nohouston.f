...
c
      ...
      enddo
c
c Estimation uses first-stage probabilities bootstrapped without
c Houston.
c
      open(30,file='../probabilities_2/fitprob1_nohou_200.txt')
      rewind(30)
      do j=1,ncnb1
         read(30,*)  idnb1(j),idf1(j),p1(1,j),p1(2,j),p1(3,j)
      enddo
c
      open(31,file='../probabilities_2/fitprob2_nohou_200.txt')
      rewind(31)
      do j=1,ncnb2
         read(31,*) idnb2(j),idf2(j),p2(1,j),p2(2,j),p2(3,j)
      enddo
c
      open(32,file='../probabilities_2/fitprob3_nohou_200.txt')
      rewind(32)
      do j=1,ncnb3
         read(32,*) idnb3(j),idf3(j),p3(1,j),p3(2,j),p3(3,j)
      enddo
c
      open(33,file='../probabilities_2/fitprob4_nohou_200.txt')
      rewind(33)
      do j=1,ncnb4
         read(33,*) idnb4(j),idf4(j),p4(1,j),p4(2,j),p4(3,j)
      enddo
c
      open(34,file='../probabilities_2/fitprob5_nohou_200.txt')
      rewind(34)
      do j=1,ncnb5
         read(34,*) idnb5(j),idf5(j),p5(1,j),p5(2,j),p5(3,j)
      enddo     
c
      open(900,file='stage2_common2_out_nohou_a.txt')
      rewind(900)
...
c
         ...
         yub(1) = 3.d0
c
c Houston-specific lat-lon parameters are constrained to be zero.
c
         yguess(14) = 0.d0
         yguess(15) = 0.d0
         ylb(14) = 0.d0
